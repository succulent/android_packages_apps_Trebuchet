...
public class AutoDoubleNumberPickerPreference extends DialogPreference implements
    ...
    protected View onCreateDialogView() {
        ...
        View view = inflater.inflate(R.layout.auto_double_number_picker_dialog, null);
    ...
    public void onClick(View v) {
        if (mCheckBox.isChecked()) {
            mNumberPicker1.setValue(mDefault1);
            mNumberPicker1.setEnabled(false);
            mNumberPicker2.setValue(mDefault2);
            mNumberPicker2.setEnabled(false);
        } else {
            mNumberPicker1.setEnabled(true);
            mNumberPicker2.setEnabled(true);
        }
    }
